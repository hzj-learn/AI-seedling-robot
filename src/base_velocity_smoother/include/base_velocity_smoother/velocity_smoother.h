#ifndef VELOCITY_SMOOTHER_H
#define VELOCITY_SMOOTHER_H
...
#include"base_velocity_smoother/paramsConfig.h"
...
namespace base_velocity_smoother {
...
private:
  ...
  ** Dynamic Reconfigure
  **********************/
  dynamic_reconfigure::Server<base_velocity_smoother::paramsConfig> *             dynamic_reconfigure_server;
  dynamic_reconfigure::Server<base_velocity_smoother::paramsConfig>::CallbackType dynamic_reconfigure_callback;
  void reconfigCB(base_velocity_smoother::paramsConfig &config, uint32_t unused_level);
};

} // base_velocity_smoother

#endif /* VELOCITY_SMOOTHER_HPP_ */

#endif // VELOCITY_SMOOTHER_H
