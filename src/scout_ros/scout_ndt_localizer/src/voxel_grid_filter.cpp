...
#include <scout_ndt_localizer/PointsDownsamplerInfo.h>
...
static scout_ndt_localizer::PointsDownsamplerInfo points_downsampler_info_msg;
...
int main(int argc, char** argv)
{
  ...
  points_downsampler_info_pub = nh.advertise<scout_ndt_localizer::PointsDownsamplerInfo>("/points_downsampler_info", 1000);
